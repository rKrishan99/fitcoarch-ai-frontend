...
const TestimonialsSection = () => {
  return (
    <div className="overflow-hidden bg-background-500 dark:bg-secondary-600 px-[30px] xl:px-[120px] py-20">
      <h1 className="text-4xl font-semibold text-center">
        What Our Users Are Saying{" "}
      </h1>
      <div className="flex flex-col md:flex-row  mt-10 justify-center items-center gap-8">
        <div className="bg-background-400 dark:bg-secondary-500 p-8 rounded-lg max-w-[400px]">
