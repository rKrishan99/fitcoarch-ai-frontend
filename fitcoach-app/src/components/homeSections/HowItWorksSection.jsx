...
const HowItWorksSection = () => {
  return (
    <div className="overflow-hidden bg-background-400 dark:bg-secondary-600 px-[30px] xl:px-[120px] py-20">
      ...
      <div className="flex flex-col md:flex-row mt-12 justify-around gap-6 md:px-20">
        <div className="bg-background-500 dark:bg-secondary-500 rounded-lg p-8 flex flex-col items-center gap-4">
          <div className="bg-primary-300 w-16 h-16 flex items-center justify-center rounded-full">
            <FaUser size={28} className="text-primary-400" />
          </div>
        ...
        <div className="bg-background-500 dark:bg-secondary-500 rounded-lg p-8 flex flex-col items-center gap-4">
          <div className="bg-primary-300 w-16 h-16 flex items-center justify-center rounded-full">
            <PiNotepadFill size={28} className="text-primary-400" />
          </div>
        ...
        <div className="bg-background-500 dark:bg-secondary-500 rounded-lg p-8 flex flex-col items-center gap-4">
          <div className="bg-primary-300 w-16 h-16 flex items-center justify-center rounded-full">
            <AiFillSignal size={28} className="text-primary-400" />
          </div>
